...
public class ConeTC extends PApplet {
    ...
    public void setup() {
        ...
        Button btStartAnimation = cp5.addButton("Calculate temperature")
                .setPosition(300, 600)
                .setSize(200, 30)
                .setColor(ControlP5.THEME_GREY);
        btStartAnimation.addCallback(new CallbackListener() {
            @Override
            public void controlEvent(CallbackEvent event) {
                if (event.getAction() == ControlP5.ACTION_PRESS) {
                    for (double i = 0; i < time; i = i + time / steps) {
                        btStartAnimation.setColor(ControlP5.THEME_RED);
                        btStartAnimation.setLabel("animation is running");
                    ...
                    btStartAnimation.setLabel("Start animation");
